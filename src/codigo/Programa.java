		...
		for (Retangulo corteAtual : muitosCortes) {
			...
			for (int i = 0; i < tamanho; i++) {
				...
				if (interserc.estaNasQuinas(ret, corteAtual) == true)
					...
					ArrayList<Retangulo> vertical = interserc.cortaHorizontalmente(ret, corteAtual);
					Retangulo baixo = vertical.get(0);
					Retangulo meio = vertical.get(1);
					Retangulo topo = vertical.get(2);
					...
					ArrayList<Retangulo> horizontal = interserc.cortaVerticalmente(meio, corteAtual);
					Retangulo esquerda = horizontal.get(0);
					Retangulo centro = horizontal.get(1);
					Retangulo direita = horizontal.get(2);
